...
locals {
  ...
  aks_default_node_max_surge_is_zero       = can(regex("^0+%?$", local.aks_default_node_max_surge_trim))
  aks_default_node_upgrade_max_unavailable = local.aks_default_node_max_surge_is_zero ? "1" : null
}
...
resource "azurerm_kubernetes_cluster" "aks" {
  ...
  default_node_pool {
    ...
    upgrade_settings {
      ...
      max_unavailable = local.aks_default_node_upgrade_max_unavailable
    }
  }
