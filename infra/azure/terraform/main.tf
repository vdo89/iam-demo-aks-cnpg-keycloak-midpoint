...
locals {
  ...
  aks_default_node_max_surge_effective = local.aks_default_node_max_surge_trim == "0" ? "1" : local.aks_default_node_max_surge_trim
}
...
resource "azurerm_kubernetes_cluster" "aks" {
  ...
  default_node_pool {
    ...
    upgrade_settings {
      max_surge = local.aks_default_node_max_surge_effective
    }
  }
