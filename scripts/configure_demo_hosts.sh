...
main() {
  ...
  log "✅ GitOps manifest patches updated." 
  log "Commit and push the changes so Argo CD reconciles the new hosts."
  log "Planned Keycloak URL: http://${KC_HOST}/"
  log "Planned midPoint URL: http://${MP_HOST}/midpoint"
}
